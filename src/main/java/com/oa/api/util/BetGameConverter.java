...
public class BetGameConverter {
    ...
    public BetGameDTO converModeltoDTO(HashMap<String, Object> betGame){
        ...
        result.setBest_odds(Double.parseDouble(String.valueOf(betGame.get(BetGameFields.BEST_ODDS.getFieldName()))));
    ...
    private void setBookmakerOdds(List<HashMap<String, Object>> odds, BetGameDTO dto, Bookmakers bookmaker){
        switch(bookmaker){
            case BET365:
                ...
                if(odd365!= null){
                    dto.setLatest_b365_odds(Double.parseDouble(String.valueOf(odd365.get(BetGameFields.LATEST_ODDS.getFieldName()))));
                    dto.setOpening_b365_odds(Double.parseDouble(String.valueOf(odd365.get(BetGameFields.OPENING_ODDS.getFieldName()))));
            ...
            case ONEXBET:
                ...
                if(onexbet!= null){
                    dto.setLatest_1xbet_odds(Double.parseDouble(String.valueOf(onexbet.get(BetGameFields.LATEST_ODDS.getFieldName()))));
                    dto.setOpening_1xbet_odds(Double.parseDouble(String.valueOf(onexbet.get(BetGameFields.OPENING_ODDS.getFieldName()))));
            ...
            case PINNACLE:
                ...
                if(pinnacle!= null){
                    dto.setLatest_pinnacle_odds(Double.parseDouble(String.valueOf(pinnacle.get(BetGameFields.LATEST_ODDS.getFieldName()))));
                    dto.setOpening_pinnacle_odds(Double.parseDouble(String.valueOf(pinnacle.get(BetGameFields.OPENING_ODDS.getFieldName()))));
